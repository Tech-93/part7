    ...
    <div>
      <Router>
        <div>
          ...
          <Route path="/anecdotes/:id" render={({match}) => <Anecdote anecdote={props.anecdoteById(match.params.id)} />} />
          <Route path="/create" render={() => 
          !props.notification ?  <CreateNew addNew={props.addNew} setNotification={props.setNotification} /> : <Redirect to="/" /> } />
...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.setNotification('a new anecdote created!')
    setTimeout(() => {
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdoteById={anecdoteById} notification={notification} setNotification={setNotification} />
      <Footer />
    </div>
  )
}
